import pygame
from get_keys import get_player_keys
...
def show_menu_screen(color=cfg.white, font=cfg.font):
    ...
    while num_players not in [1, 2, 3, 4, 5, 6]:
        ...
        screen.blit(text, (cfg.screen_width/2 - text.get_width()/2, cfg.screen_height/2 - text.get_height()/2 + 80))
        text = font.render("4 players", True, (0, 0, 0))
        screen.blit(text, (cfg.screen_width/2 - text.get_width()/2, cfg.screen_height/2 - text.get_height()/2 + 110))
        text = font.render("5 players", True, (0, 0, 0))
        screen.blit(text, (cfg.screen_width/2 - text.get_width()/2, cfg.screen_height/2 - text.get_height()/2 + 140))
        text = font.render("6 players", True, (0, 0, 0))
        screen.blit(text, (cfg.screen_width/2 - text.get_width()/2, cfg.screen_height/2 - text.get_height()/2 + 170))
