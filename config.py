...
def set_args(arg_file=None):
    ...
    arg_parser.add_argument(
        "--save_model_path",
        type=str,
        default="/home/simon/Documents/Freizeit/Kurven-Fieber-main/model-states/",
    )
    arg_parser.add_argument("--run_name", type=str, default="DQN-main")
    ...
    player_min_collision = int(30 / args.speed)
    white = (255, 255, 255)
    black = (0, 0, 0)
    green = (0, 255, 0)
    red = (255, 0, 0)
    ...
    min_gap = args.min_gap * 5 // args.speed
    max_gap = args.max_gap * 5 // args.speed
    ...
    save_model_path = f"{args.save_model_path}{args.run_name}/"
