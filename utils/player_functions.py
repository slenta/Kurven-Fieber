...
from items.items import check_for_item_collision, power_down
from curveai.ai_player import update_ai_player_direction
...
def move_player(player, game_state, players=None):
    ...
    if player["alive"]:
        ...
        player["pos_history"] = player["pos_history"][: cfg.player_min_collision + 5]
